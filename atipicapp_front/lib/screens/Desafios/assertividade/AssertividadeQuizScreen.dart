...
import 'package:video_player/video_player.dart'; // Adicionada a importação correta
...
class _VideoQuizScreenState extends State<VideoQuizScreen> {
      ...
      body: Column(
        ...
        children: [
          _controller.value.isInitialized
              ...
              : Center(child: CircularProgressIndicator()), // Centralizado o loader
          SizedBox(height: 20), // Adicionado espaço abaixo do vídeo
          if (_showOptions)
            Column(
  ...
  Widget _buildOption(String text, bool isCorrect) {
    return Padding(
      padding: EdgeInsets.symmetric(vertical: 8, horizontal: 20), // Mais espaçamento
