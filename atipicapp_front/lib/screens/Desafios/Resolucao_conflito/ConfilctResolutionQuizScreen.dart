...
class _VideoQuizScreenState extends State<Confilctresolutionquizscreen> {
  ...
  void initState() {
    super.initState();
        _controller = VideoPlayerController.asset('assets/videos/cSugerirqueumdosdoissaiadasala.mp4')      ..initialize().then((_) {
        setState(() {});
        _controller.play();
      });
